...
export default function ProposalsHeader({ params, onNavigateBack, onRegenerateItinerary }: ProposalsHeaderProps) {
        ...
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
          <div className="flex-1">
            <h1 className="text-3xl md:text-5xl font-bold mb-3">
              Proposte di viaggio per {params.destination}
            </h1>
            ...
            <p className="mt-4 text-slate-300 max-w-2xl leading-relaxed">
              Scegli una delle proposte complete oppure prenota singolarmente voli, alloggi e attività.
            </p>
          </div>
